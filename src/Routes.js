...
const Routes = ({ appProps }) => {
  return (
    <Switch>
      ...
      <AuthenticatedRoute path="/courses/:courseId" exact component={Courses} appProps={appProps} />
      <AuthenticatedRoute path="/courses/:courseId/applications/:applicationId" exact component={Application} appProps={appProps} />
